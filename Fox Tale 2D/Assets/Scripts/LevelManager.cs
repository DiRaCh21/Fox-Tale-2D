...
public class LevelManager : MonoBehaviour
{
    ...
    public IEnumerator EndLevelCo()
    {
        ...
        {
            if(gemsCollected > PlayerPrefs.GetInt(SceneManager.GetActiveScene().name + " gems", gemsCollected))
            {
        ...
        {
            if (timeInLevel < PlayerPrefs.GetFloat(SceneManager.GetActiveScene().name + " time", timeInLevel))
            {
